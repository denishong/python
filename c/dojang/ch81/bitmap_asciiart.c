...
int main()
{
    ...
    {
			printf("file Header is not matched!! %d\n", __LINE__);
        fclose(fpBmp);
        return 0;
    }
    ...
    {
			printf("file Header is not matched!! line number : %d, bfType : %d\n", __LINE__, fileHeader.bfType);
        fclose(fpBmp);
        return 0;
    }
    ...
    {
			printf("file Header is not matched!! line number : %d, BitCout : %d\n", __LINE__,infoHeader.biBitCount );
        fclose(fpBmp);
        return 0;
    }
